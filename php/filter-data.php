                            ...
                            ?>
                                <tr class="dark:hover:bg-gray-200" >
                                    <td class="px-4 py-4 text-medium font-medium text-black-700 dark:text-black-200 whitespace-nowrap">
                                        ...
                                        <input type="checkbox" name="seleccionados[]" value="<?php echo htmlspecialchars($usuario['correo_electronico']); ?>" class="text-blue-500 rounded dark:bg-black dark:ring-offset-black-900 dark:border-black-700">
